...
export const toCssVariables = (mode) => {
  ...
  return {
    ...
    '--color-common-textSub': Colors.common.textSub,
    '--color-common-textSub50': Colors.common.textSub50,
...
export const genThemeWithPaletteMode = (paletteMode) => ({
  ...
  palette: {
    ...
    text: {
      ...
      secondary: toCssVariables(paletteMode)['--color-common-textSub'],
      secondary50: toCssVariables(paletteMode)['--color-common-textSub50'],
