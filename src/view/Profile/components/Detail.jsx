  ...
  return (
    <div className={`detail bd-left ${className}`}>
      <div className="detail__balance p-3 bd-bottom">
        <div className="capitalize flex justify-between bd-bottom pb-4 fs-16">
          ...
          <div className="text-right">
            ...
            <button className="rounded-sm fs-10 px-4 py-1 mt-1 fw-semibold text-main">
      ...
      <div className="detail__oder p-3 bd-bottom">
        <div className="capitalize flex justify-between fs-16">
          My oder
          <button
      ...
      <div className="detail__stat p-3">
        <div className="capitalize flex justify-between fs-16 mb-4">
          Trade Stats
